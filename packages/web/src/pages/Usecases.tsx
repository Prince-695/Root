...
npx rooot@latest --yes init
npx rooot@latest add auth
npx rooot@latest add resource note
...
pnpm install && pnpm dev`}
      ...
      <CommandPlate title="terminal" code="npx rooot@latest add resource product" />
      <CommandPlate
        title="HTTP idea"
...
POST /api/product           → needs Bearer token
     { "title": "Mug" }`}
      ...
      <CommandPlate title="terminal" code="npx rooot@latest --dry-run add resource invoice" />
